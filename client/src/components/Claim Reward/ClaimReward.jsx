...
try{
  // Ensure the contracts are initialized
 ...
 console.log(userRewardInTokens);
  ...
  // Get the reward token balance in the staking contract
  ...
  // Check if the contract has enough VGT tokens
